...
\end{framed}
    ...
    % sentence 1: ∀x(A(x) ∨ (P(x) ∧ Q(x)))
%     Domain: Let the domain be 
% {
% 1
% ,
% 2
...
% We assign truth values for the predicates 
% 𝐴
% A, 
% 𝑃
% P, and 
% 𝑄
% Q at each element of the domain in such a way that we can make Sentence 1 true but Sentence 2 false.
